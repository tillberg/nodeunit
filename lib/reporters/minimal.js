...
exports.run = function (files, options, callback) {
    ...
    var tracker = track.createTracker(function (tracker) {
        var numUnfinished = tracker.unfinished();
        if (numUnfinished) {
            console.log('');
            ...
            if (!options.dontCrashOnFailure) {
                console.log('nodeunit found ' + numUnfinished + ' unfinished tests. Use { dontCrash: true } to make this behave better and not throw an exception.');
            }
        }
    });
    ...
    var opts = {
        ...
        testDone: function (name, assertions) {
            ...
            if (callback) {
                var msg = assertions.failures() ? 'We had ' + assertions.failures() + ' test failures' : undefined;
                if (!options.dontCrashOnFailure) {
                    callback(msg);
                } else {
